...
- Ask only for a Xquik API key or for an environment variable name that already contains it.
...
3. Configure the API key through the host's secret or environment system.
