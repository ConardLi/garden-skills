...
要不要合成音频做"自动播放录屏"？
  ✓ 合成 → 扫所有章节的 narrations.ts 出 audio-segments.json，
           ...
           内置三个 provider：
             ...
             • mimo    (MIMO_API_KEY)   —— curl-based，9 个预置音色，中文口播强
...
| [`templates/scripts/tts-providers/README.md`](templates/scripts/tts-providers/README.md) | 换 / 加 TTS provider 时 | 三函数契约 + 内置 3 个 (minimax / openai / mimo) + 5 种现成代码片段（ElevenLabs / edge-tts / macOS say / Azure / Google） |
